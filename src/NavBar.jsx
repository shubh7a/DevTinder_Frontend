...
dispatch(removeUser());
 ...
 //  setError(err.message);
  ...
  <Link to="/login">
    <button className="btn bg-yellow-400 text-black hover:bg-yellow-500 border-none rounded-xl">
      Login
    </button>
  </Link>
  ...
  <Link to="/login">
    <figure>
      <img
        className="w-10 rounded-full border-2 border-yellow-300"
...
//           <div className="text-blue-200 text-lg md:text-xl">
...
//                 <Link
//                   to="/profile"
//                   className="justify-between text-green-400 text-lg"
//                 >
//                   Profile
//                   <span className="badge text-blue-500">
//                     New
//                   </span>
//                 </Link>
//               </li>
...
//                   className="text-green-400 text-lg text-left"
//                 >
//                   Logout
//                 </button>
//               </li>
...
//           {/* Login Button */}
//           <button
//             className="btn bg-yellow-400 text-black hover:bg-yellow-500 border-none rounded-xl"
//             onClick={() =>
//               navigate("/login", {
//                 state: { isLoginForm: true },
//               })
...
//           {/* Signup Button */}
//           {/* <button
//             className="btn bg-green-500 text-white hover:bg-green-600 border-none rounded-xl"
//             onClick={() =>
//               navigate("/sigup", {
